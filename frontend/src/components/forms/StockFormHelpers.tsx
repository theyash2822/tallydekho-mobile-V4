...
export const modalStyles = StyleSheet.create({
  ...
  /** @deprecated Prefer BottomModalShell scroll style (flexGrow:0) */
  scrollBody: { flexGrow: 0 },
  scroll:     { padding: SPACING.md, paddingBottom: SPACING.lg },
  footer:     { paddingHorizontal: SPACING.md, paddingTop: SPACING.sm, borderTopWidth: 1, borderTopColor: COLORS.borderDefault, backgroundColor: COLORS.cardBg },
