    ...
    if (activeTab === 'myentries') {
      ...
      getMyEntries(companyGuid, { from: fromDate, to: toDate, limit: String(PAGE_SIZE), page: 1, lifecycleFilter })
        .then((res: any) => {
          ...
          const allMerged = [...queueRows, ...postedFiltered]
                        ...
                        <View key={entry.id}>
                          ...
                          >
                            ...
                            <View style={s.entryInfo}>
                              ...
                              {/* Linked Receipt badge — shown on Receipt rows auto-generated by collect_payment */}
                              {entry.linkedInvoiceRef ? (
                                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 2 }}>
                                  <Ionicons name="link-outline" size={11} color={COLORS.info} />
                                  <Text style={{ fontSize: 10, color: COLORS.info, fontWeight: '600' }}>
                                    Auto-receipt • Invoice {entry.linkedInvoiceRef}
                                  </Text>
                                </View>
                              ) : null}
