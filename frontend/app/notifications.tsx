...
const s = StyleSheet.create({
  ...
  markAll: { fontSize: TYPOGRAPHY.sm, color: COLORS.positive, fontWeight: '600' },
  ...
  unreadCard: { borderLeftWidth: 3, borderLeftColor: COLORS.positive, backgroundColor: '#FAFFFE' },
  ...
  actionBtn: { alignSelf: 'flex-start', marginTop: 4, backgroundColor: COLORS.positiveBg, paddingHorizontal: 12, paddingVertical: 6, borderRadius: RADIUS.md },
  actionTxt: { fontSize: TYPOGRAPHY.xs, fontWeight: '700', color: COLORS.positive },
  unreadDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: COLORS.positive, marginTop: 4 },
