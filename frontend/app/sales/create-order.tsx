...
export default function CreateSalesOrderScreen() {
  ...
  const updateItem = useCallback((id:string,f:keyof OItem,v:string)=>setItems(prev=>prev.map(i=>i.id===id?{...i,[f]:v}:i)),[]);
  ...
  const handleSubmit = useCallback(()=>{
    Alert.alert('✓ Order Created', `Sales Order ${orderNo} created successfully!`,[{text:'OK',onPress:()=>router.back()}]);
  },[orderNo,router]);
