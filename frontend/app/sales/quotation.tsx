  ...
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.hdr}>
        ...
        <Text style={s.hdrTitle}>Quotations</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={s.search}><Ionicons name="search" size={16} color={COLORS.textTertiary} />
          <TextInput style={s.searchIn} placeholder="Search quotations..." placeholderTextColor={COLORS.textTertiary} value={search} onChangeText={setSearch} />
        ...
        <View style={s.secHdr}><Text style={s.secT}>Quotations</Text><TouchableOpacity style={s.menuB}><Ionicons name="ellipsis-horizontal" size={20} color={COLORS.textSecondary} /></TouchableOpacity></View>
        <View style={s.card}>
          {filtered.map((o, idx) => (
            <View key={o.id}>
