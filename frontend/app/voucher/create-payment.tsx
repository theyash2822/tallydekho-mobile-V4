...
import { createPaymentVoucher } from '../../src/services/api';
...
export default function CreatePaymentVoucher() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Toast.show({ type: 'success', text1: 'Voucher Posted', text2: `Payment Voucher ${voucherNo} posted to Tally.` });
  ...
  const handleSaveOptional = () => {
    Toast.show({ type: 'info', text1: 'Draft Saved', text2: 'Payment Voucher saved as optional.' });
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
          ...
          <View style={s.btnRow}>
            ...
            <TouchableOpacity style={[s.btnPrimary, submitting && { opacity: 0.6 }]} onPress={handleSubmit} activeOpacity={0.8} disabled={submitting}>
              ...
              <Text style={s.btnPriTxt}>{submitting ? 'Submitting...' : 'Submit Payment'}</Text>
            </TouchableOpacity>
          </View>
