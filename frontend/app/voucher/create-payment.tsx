...
const voucherNo = 'PV-' + String(Math.floor(1000 + Math.random() * 9000));
...
export default function CreatePaymentVoucher() {
  ...
  const handleSubmit = () => {
    ...
    Toast.show({ type: 'success', text1: 'Voucher Posted', text2: `Payment Voucher ${voucherNo} posted successfully.` });
    setTimeout(() => router.replace('/document/PV-2089?type=payment_voucher' as any), 800);
  };

  const handleSaveOptional = () => {
    Toast.show({ type: 'success', text1: 'Draft Saved', text2: 'Payment Voucher saved as optional.' });
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
          ...
          <View style={s.infoRow}>
            ...
            <View style={s.infoItem}>
              ...
              <Text style={s.infoTxt}>Payment Voucher</Text>
            </View>
          </View>
          ...
          <View style={s.btnRow}>
            ...
            <TouchableOpacity style={s.btnPrimary} onPress={handleSubmit} activeOpacity={0.8}>
              ...
              <Text style={s.btnPriTxt}>Submit Payment</Text>
            </TouchableOpacity>
          </View>
