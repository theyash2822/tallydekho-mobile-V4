...
export default function CreateJournalVoucher() {
  ...
  const handleSubmit = () => {
    ...
    Toast.show({ type: 'success', text1: 'Voucher Posted', text2: `Journal Voucher ${voucherNo} posted successfully.` });
    setTimeout(() => router.replace('/document/PV-2089?type=journal_voucher' as any), 800);
  };

  const handleSaveOptional = () => {
    Toast.show({ type: 'success', text1: 'Draft Saved', text2: 'Journal Voucher saved as optional.' });
