  ...
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.hdr}>
        ...
        <TouchableOpacity style={s.hdrAct} onPress={() => safePush(router, '/voucher/create-journal' as any)} activeOpacity={0.8}>
      ...
      >
        ...
        {isLoading ? (
          ...
          <View style={s.empty}>
            ...
            <TouchableOpacity style={s.emptyBtn} onPress={() => safePush(router, '/voucher/create-journal' as any)}>
            ...
            {filtered.map((item, idx) => (
              <View key={item.id}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (item.tdkRef) {
                      safePush(router, `/voucher/journal-preview?tdkRef=${encodeURIComponent(item.tdkRef)}` as any);
                    }
                  }}
                >
