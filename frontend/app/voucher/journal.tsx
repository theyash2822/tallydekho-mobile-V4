...
import { MOCK_JOURNAL_VOUCHERS } from '../../src/data/mockData';
    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={s.statsRow}>
          {[{l:'Total Dr/Cr',v:data.summary.total},{l:'Docs',v:String(data.summary.docs)},{l:'Period',v:'Jan 25'},{l:'All Posted',v:'✓'}].map(st=>(
